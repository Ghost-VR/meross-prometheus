...
class PowerMonitor:
  ...
  def print_power_metrics(self) -> None:
    ...
    print(f"({self._device.name}) POWER = {self._power_info.power} W, VOLTAGE = {self._power_info.voltage} V, CURRENT = {self._power_info.current} A")
